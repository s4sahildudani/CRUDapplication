      ...
      <div>
        ...
        <TableContainer component={Paper}>
          <Table sx={{ minWidth: 650 ,textAlign:"center" }} aria-label="simple table">
            <TableHead>
              <TableRow>
                <TableCell style={{ width: "35%",fontSize:"25px" }}>
                  <b>Title</b>
                </TableCell>
                <TableCell style={{ width: "45%" ,fontSize:"25px" }}>
                  <b>Body</b>
                </TableCell>
                <TableCell style={{ width: "20%" ,fontSize:"25px" }}>
                  <b>Actions</b>
                </TableCell>
              </TableRow>
            </TableHead>
                ...
                <TableRow key={post.id}>
                  {isEditing && editedPostId === post.id ? (
                    ...
                    <>
                      ...
                      <TableCell style={{ display: "flex", padding: "4%" }}>
                        <svg
